...
public class NoiseEffect : MonoBehaviour
{
	...
	private float noiseX1;// = Random.value * 100;
	private float noiseX2;// = Random.value * 100;
	...
	protected void Start ()
	{
		...
		noiseX1 = Random.value * 100;
		noiseX2 = Random.value * 100;
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination)
	{
		...
		mat.SetVector("_GrainOffsetScale", new Vector4(
			Mathf.PerlinNoise(noiseX1, noiseY),
			Mathf.PerlinNoise(noiseX2, noiseY),
